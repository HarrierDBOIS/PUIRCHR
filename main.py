...
from server.routes.route_for_redirect_for_info_text import router as route_for_redirect_for_next_text
...
app.mount("/media", StaticFiles(directory=r"C:\Users\kukid\PycharmProjects\puirchr\PUIRCHR\media"), name="media")
app.mount("/static", StaticFiles(directory=r"C:\Users\kukid\PycharmProjects\puirchr\PUIRCHR\static\css"), name="static")
