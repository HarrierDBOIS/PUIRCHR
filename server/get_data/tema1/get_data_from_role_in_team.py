...
async def read_role_data(
    file_path: str = r"C:\Users\kukid\PycharmProjects\puirchr\PUIRCHR\server\data\tema1\role_in_team.csv",
):
...
def get_result_from_role(data: dict):
    ...
    if max_key == "a":
        description = (
            "Ваш результат - аналитик (мыслитель, стратег) – вы обладаете проницательным умом, "
        ...
        description = (
            "Ваш результат - исполнитель (практик, реалист) – вы организованный, ответственный человек, "
        ...
        description = (
            "Ваш результат - инициатор (новатор, экспериментатор) – вы человек идей, полны энергии и "
        ...
        description = (
            "Ваш результат - коммуникатор (дипломат, гармонизатор) – вы умеете строить отношения, "
